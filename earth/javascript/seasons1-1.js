...
var month_data = {
    "jan": { index:  0, num:   1, short_name: 'JAN', long_name: 'Januar' },
    "feb": { index:  1, num:   2, short_name: 'FEB', long_name: 'Februar' },
    "mar": { index:  2, num:   3, short_name: 'MÄR', long_name: 'März' },
    "apr": { index:  3, num:   4, short_name: 'APR', long_name: 'April' },
    "may": { index:  4, num:   5, short_name: 'MAi', long_name: 'Mai' },
    "jun": { index:  5, num:   6, short_name: 'JUN', long_name: 'Juni' },
    "jul": { index:  6, num:   7, short_name: 'JUL', long_name: 'Juli' },
    "aug": { index:  7, num:   8, short_name: 'AUG', long_name: 'August' },
    "sep": { index:  8, num:   9, short_name: 'SEP', long_name: 'September' },
    "oct": { index:  9, num:  10, short_name: 'OKT', long_name: 'Oktober' },
    "nov": { index: 10, num:  11, short_name: 'NOV', long_name: 'November' },
    "dec": { index: 11, num:  12, short_name: 'DEZ', long_name: 'Dezember' }
};
